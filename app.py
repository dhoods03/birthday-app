...
<script>
    ...
    const milestones = {
        10: { title: "A Radiant Soul", text: "Your presence is a constant in a world of variables. You bring a balance that numbers can't explain.", img: "✨" },
        ...
        40: { title: "Eid Milad Sa'id!", text: "May your day be blessed with peace, your heart with joy, and your life with endless love.", img: "🌙" }
    };
    ...
    function showCard(data) {
        ...
        if(score >= 40) {
            // Festive Eid Milad Confetti Burst
            var end = Date.now() + (2 * 1000);
            var colors = ['#2D5A52', '#D4AF37', '#ffffff'];
...
st.markdown("<p class='footer'>Eid Milad Sa'id. <br> <i>Specially developed for a unique soul.</i></p>", unsafe_allow_html=True)
